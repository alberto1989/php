...
<div id="centro">
	...
	<div id="contenido">
        ...
        $mysqli= conectar();
        $sql="select count(id_usuarios) as total from usuarios where nombre like '%$buscar%'";
   ...
   $sql="select * from usuarios  where nombre like '%$buscar%' order by id_usuarios limit $inicio,$TAMANO_PAGINA";
	...
	<div id="pie">
        ...
        if($totalP>1){
          ...
          echo "<p>";
            ...
            echo "<a href='BuscadorPaginacion.php?txtB=$buscar&pagina=$i'>[$i] </a> ";
